...
*/
import { assert, MODES, ACTIONS, EXPIRY_STRATEGIES, Serializers, PollyError } from '@pollyjs/utils';
...
class Adapter {
  ...
  async replay(pollyRequest) {
    ...
    if (recordingEntry) {
      ...
      return this.onReplay(pollyRequest, normalizeRecordedResponse(recordingEntry.response), recordingEntry);
    }
