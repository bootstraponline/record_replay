/**
* @pollyjs/adapter-node-http v2.6.3
*
...
import { URL as URL$1, HTTP_METHODS } from '@pollyjs/utils';
...
function parseRequestArguments(url, options, callback) {
  ...
  options = objectSpread({}, url || {}, options || {});
  return {
    options,
    callback
  };
...
class HttpAdapter extends Adapter {
  ...
  setupNock() {
    ...
    HTTP_METHODS.forEach(m => {
      ...
      interceptor.intercept(/.*/, m).reply(function (_, body, respond) {
        ...
        const parsedArguments = parseRequestArguments(...REQUEST_ARGUMENTS.get(req));
        const url = getUrlFromOptions(parsedArguments.options); // body will always be a string unless the content-type is application/json
  ...
  async respondToRequest(pollyRequest, error) {
    ...
    if (error) {
      ...
      respond(error); // This allows the consumer to handle the error gracefully
