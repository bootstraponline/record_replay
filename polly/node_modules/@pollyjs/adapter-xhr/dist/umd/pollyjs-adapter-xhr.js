...
(function (global, factory) {
            ...
            (global = global || self, global['@pollyjs/adapter-xhr'] = factory());
            ...
            */
            ...
            function fakeXMLHttpRequestFor(globalScope) {
                ...
                justExtend(FakeXMLHttpRequest.prototype, event$1.EventTarget, {
                    ...
                    readyStateChange: function readyStateChange(state) {
                        ...
                        var readyStateChangeEvent = new event$1.Event("readystatechange", false, false, this);
                        var event, progress;
                        ...
                        if (this.readyState === FakeXMLHttpRequest.DONE) {
                            ...
                            if (supportsProgress) {
                                this.upload.dispatchEvent(new event$1.ProgressEvent("progress", progress, this));
                                this.upload.dispatchEvent(new event$1.ProgressEvent(event, progress, this));
                                this.upload.dispatchEvent(new event$1.ProgressEvent("loadend", progress, this));
                            }

                            this.dispatchEvent(new event$1.ProgressEvent("progress", progress, this));
                            this.dispatchEvent(new event$1.ProgressEvent(event, progress, this));
                            this.dispatchEvent(new event$1.ProgressEvent("loadend", progress, this));
                        }
                    ...
                    send: function send(data) {
                        ...
                        this.dispatchEvent(new event$1.Event("loadstart", false, false, this));
                    },
                    ...
                    uploadProgress: function uploadProgress(progressEventRaw) {
                        if (supportsProgress) {
                            this.upload.dispatchEvent(new event$1.ProgressEvent("progress", progressEventRaw, this.upload));
                        }
                    },

                    downloadProgress: function downloadProgress(progressEventRaw) {
                        if (supportsProgress) {
                            this.dispatchEvent(new event$1.ProgressEvent("progress", progressEventRaw, this));
                        }
                    },

                    uploadError: function uploadError(error) {
                        if (supportsCustomEvent) {
                            this.upload.dispatchEvent(new event$1.CustomEvent("error", {detail: error}));
                        }
                    },
            ...
            var fakeXhr = justExtend(fakeXMLHttpRequestFor(commonjsGlobal), { fakeXMLHttpRequestFor: fakeXMLHttpRequestFor });
                ...
                return regenerator.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        if (!(supportsBlob$1 && body instanceof Blob)) {
                          _context.next = 4;
                          break;
                        }
            ...
            var supportsFormData$1 = typeof FormData !== 'undefined';
              ...
              regenerator.mark(function _callee(body) {
                ...
                return regenerator.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        if (!(supportsFormData$1 && body instanceof FormData)) {
                          _context.next = 35;
                          break;
                        }
                      ...
                      case 7:
                        ...
                        if (!(supportsBlob$1 && value instanceof Blob)) {
                          _context.next = 16;
                          break;
                        }
            ...
            function serialize$2(body) {
              if (supportsBuffer && body) {
                ...
                } else if (supportsArrayBuffer$1 && ArrayBuffer.isView(body)) {
              ...
              createClass(Adapter, [{
                ...
                value: function () {
                  ...
                  regenerator.mark(function _callee6(pollyRequest) {
                    var config, recordingEntry, message;
                      ...
                      while (1) {
                        switch (_context6.prev = _context6.next) {
                          ...
                          case 7:
                            ...
                            _context6.next = _context6.t0 === EXPIRY_STRATEGIES.RECORD ? 12 : _context6.t0 === EXPIRY_STRATEGIES.ERROR ? 13 : _context6.t0 === EXPIRY_STRATEGIES.WARN ? 15 : 17;
                            break;
                          ...
                          case 21:
                            ...
                            return _context6.abrupt("return", this.onReplay(pollyRequest, normalizeRecordedResponse(recordingEntry.response), recordingEntry));
                ...
                key: "name",
                get: function get() {
                  _assert('Must override the static `name` getter.');
                }
              }]);
            ...
            function serializeResponseHeaders(responseHeaders) {
              ...
              return responseHeaders.split('\n').reduce(function (headers, header) {
                var _header$split = header.split(':'),
                    _header$split2 = slicedToArray(_header$split, 2),
            ...
            var stubbedXhrs = new weakSet$1();

            var XHRAdapter =
            /*#__PURE__*/
            function (_Adapter) {
              inherits(XHRAdapter, _Adapter);

              function XHRAdapter() {
                classCallCheck(this, XHRAdapter);

                return possibleConstructorReturn(this, getPrototypeOf$2(XHRAdapter).apply(this, arguments));
              }

              createClass(XHRAdapter, [{
                key: "onConnect",
                value: function onConnect() {
                  var _this = this;

                  var context = this.options.context;
                  var fakeXhrForContext = fakeXhr.fakeXMLHttpRequestFor(context);
                ...
                key: "respondToRequest",
                value: function respondToRequest(pollyRequest, error) {
                  var xhr = pollyRequest.requestArguments.xhr;
                  ...
                  if (error) {
                    ...
                    var response = pollyRequest.response;
                ...
                value: function () {
                  var _passthroughRequest = asyncToGenerator(
                  /*#__PURE__*/
                  regenerator.mark(function _callee(pollyRequest) {
                    var fakeXhr, xhr, h;
                    return regenerator.wrap(function _callee$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            fakeXhr = pollyRequest.requestArguments.xhr;
                            xhr = new this.NativeXMLHttpRequest();
                            ...
                            _context.next = 8;
                            return resolveXhr(xhr, pollyRequest.body);
                  ...
                  return function passthroughRequest(_x) {
                    return _passthroughRequest.apply(this, arguments);
                  };
                }()
              }, {
