...
(function (global, factory) {
            ...
            /*#__PURE__*/
            function (_Adapter) {
              inherits(FetchAdapter, _Adapter);

              function FetchAdapter() {
                classCallCheck(this, FetchAdapter);

                return possibleConstructorReturn(this, getPrototypeOf$2(FetchAdapter).apply(this, arguments));
              }

              createClass(FetchAdapter, [{
                key: "onConnect",
                value: function onConnect() {
                  var _this = this;
                  ...
                  */
                  ...
                  var ExtendedRequest =
                  /*#__PURE__*/
                  function (_context$Request) {
                    inherits(ExtendedRequest, _context$Request);

                    function ExtendedRequest(url, options) {
                      var _this2;

                      classCallCheck(this, ExtendedRequest);
                      ...
                      */
                      ...
                      if (url instanceof ExtendedRequest) {
                        ...
                        args = objectSpread({}, reqArgs, {
                          options: objectSpread({}, reqArgs.options, options)
                        });
                      } else {
                        args = {
                          url: url,
                      ...
                      defineProperty$4(assertThisInitialized(_this2), REQUEST_ARGUMENTS, {
                        value: args
                      });
                      return _this2;
                    }

                    createClass(ExtendedRequest, [{
                      key: "clone",
                  ...
                  context.fetch = function (url) {
                    ...
                    if (url instanceof ExtendedRequest) {
                      ...
                      url = reqArgs.url;
                      options = objectSpread({}, reqArgs.options, options); // If a body exists in the Request instance, mimic reading the body
                      ...
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            ...
                            _context.next = 4;
                            return this.nativeFetch.apply(context, [pollyRequest.url, objectSpread({}, options, {
                          ...
                          case 4:
                            ...
                            _context.t1 = serializeHeaders(response.headers);
                            _context.next = 9;
                ...
                value: function respondToRequest(pollyRequest, error) {
                  ...
                  var respond = pollyRequest.requestArguments.respond;
                  ...
                  var responseBody = statusCode === 204 && pollyResponse.body === '' ? null : pollyResponse.body;
...
//# sourceMappingURL=pollyjs-adapter-fetch.js.map
