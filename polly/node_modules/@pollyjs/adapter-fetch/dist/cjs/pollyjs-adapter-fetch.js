...
var isNode$2 = _interopDefault(require('detect-node'));
...
class FetchAdapter extends Adapter {
  ...
  onConnect() {
    ...
    if (isNode$2) {
      console.warn('[Polly] [adapter:fetch] Using the fetch adapter in Node has been deprecated. Please use the node-http adapter instead.');
    }

    ['fetch', 'Request', 'Response', 'Headers'].forEach(key => this.assert(`${key} global not found.`, !!(context && context[key])));
    ...
    */
    ...
    class ExtendedRequest extends context.Request {
      constructor(url, options) {
        ...
        */
        ...
        defineProperty$4(this, REQUEST_ARGUMENTS, {
          value: args
        });
      }
    ...
    context.fetch = (url, options = {}) => {
      let respond; // Support Request object
  ...
  async passthroughRequest(pollyRequest) {
    ...
    const response = await this.nativeFetch.apply(context, [pollyRequest.url, objectSpread({}, options, {
  ...
  respondToRequest(pollyRequest, error) {
    ...
    const responseBody = statusCode === 204 && pollyResponse.body === '' ? null : pollyResponse.body;
