...
function registerAPI(app, config) {
  ...
  router.post('/:recording', bodyParser.json({
    ...
    const {
      status,
      body
    } = api.saveRecording(recording, req.body);
...
export { API, DefaultConfig as Defaults, Server, registerAPI as registerExpressAPI };
