...
(function (global, factory) {
	...
	function deprecateRecordIfExpired(mergedConfig) {
	  if (mergedConfig.hasOwnProperty('recordIfExpired')) {
	    console.warn('[Polly] config option "recordIfExpired" is deprecated. Please use "expiryStrategy".');
	...
	function customizer(objValue, srcValue, key) {
	  ...
	  if (isArray$3(objValue) || ['context'].includes(key)) {
	    return srcValue;
	  }
	}
	...
	function mergeConfigs() {
	  ...
	  var mergedConfig = mergeWith.apply(void 0, [{}].concat(configs, [customizer]));
	...
	function validateRequestConfig(config) {
	  assert("Invalid config provided. Expected object, received: \"".concat(_typeof_1(config), "\"."), isObjectLike(config) && !isArray$3(config)); // The following options cannot be overridden on a per request basis
	...
	function () {
	  ...
	  function EventEmitter() {
	    ...
	    assert('An array of supported events must be provided via the `eventNames` option.', isArray$3(eventNames) && eventNames.length > 0);
	  ...
	  createClass(PollyRequest, [{
	    ...
	    value: function () {
	      ...
	      regenerator.mark(function _callee2(response) {
	        var _ref, statusCode, headers, body;

	        return regenerator.wrap(function _callee2$(_context2) {
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              case 0:
	                _ref = response || {}, statusCode = _ref.statusCode, headers = _ref.headers, body = _ref.body;
	                ...
	                this.response.body = body; // Trigger the `beforeResponse` event
	...
	function (_Map) {
	  ...
	  function Handler() {
	    ...
	    _this._eventEmitter = new EventEmitter({
	      eventNames: ['error', 'request', 'beforeReplay', 'beforePersist', 'beforeResponse', 'response']
	    });
	    return _this;
	  }
